...
public:
    ...
    void updateTempSensorData(float temp, uint8_t batt, uint32_t interval, const char* name);
    void getTempSensorData(float &temp, uint8_t &batt, uint32_t &lastUpdate, uint32_t &interval, char* nameBuf);
